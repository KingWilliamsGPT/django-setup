...
FRONTEND_DOMAIN = os.getenv('FRONTEND_DOMAIN', 'http://localhost:8080')
...
STRIPE_OBJECT_DELETE_WARNING = 'Do not delete this object, it was created programmatically.'
...
JWT_SECRET_KEY = os.getenv('JWT_SIGNING_KEY', 'nlt2fz*q*&+fj0*e$+vj2&l=5(%uw)rg0u6d7dt0c')
...
SWAGGER_TITLE = "Default Swagger Title"
SWAGGER_DESCRIPTION = "Default Swagger Description"
SWAGGER_VERSION = "v1"
